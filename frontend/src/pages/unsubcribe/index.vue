<template>
  ...
  >
    ...
    <Checkbox class="mt-20-px" v-model="agreeWithPolicy">
      参加を解除します
    </Checkbox>
    <Button
      type="primary"
      class="mt-20-px mb-15-px"
    ...
    >
      <div class="text-left fs-16">
        アプリへの参加解除してよろしいですか。
        <br />
        <div class="mt-10-px">参加解除後は、</div>
        本アプリをアンインストールしてください。
      </div>
    </ConfirmModal>
  </div>
