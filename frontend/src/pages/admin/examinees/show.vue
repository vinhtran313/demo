<template>
  <div class="mt-10-px">
    ...
    <div class="overalls">
      <a-row :gutter="[16, 16]">
        <a-col :span="12">
          <OverallItem class="overall-item" to="admin.examinees.steps">
      ...
      <a-row :gutter="[16, 16]">
        <a-col :span="12">
          <OverallItem class="overall-item" to="admin.examinees.sleeps">
            <template v-slot:icon>
              <IconImage
                :width="60"
                :height="60"
        ...
        <a-col :span="12">
          <OverallItem class="overall-item" to="admin.examinees.talks">
            <template v-slot:icon>
              <IconImage
                :width="60"
                :height="60"
      ...
      <a-row :gutter="[16, 16]">
        <a-col :span="12">
          <OverallItem class="overall-item" to="admin.examinees.skin-temps">
            <template v-slot:icon>
              <IconImage
                :width="60"
                :height="60"
        ...
        <a-col :span="12">
          <OverallItem class="overall-item">
            <template v-slot:icon>
            ...
            <template v-slot:content>
              <div class="ml-20-px">
                ...
                <div class="ml-15-px fs-20 mt-10-px">
                  <div>
                    Silmee
                    <span class="text-picton-blue fw-7">3日以上装着赵L</span>
                  </div>
                  <div>
                    WalkX
                    <span class="text-picton-blue fw-7">3日以上装着赵L</span>
